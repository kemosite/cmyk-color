...
var rspnsv_em_spaceAfter = Math.round((rspnsv_em_lineHeight / 3) * 1000) / 1000;
...
$("body").css("font-size", rspnsv_em_fontHeight+"em");
$("body").css("line-height", rspnsv_em_lineHeight+"em");
// $(rspnsv_elements).css("margin-top", rspnsv_em_spaceAfter+"em");
